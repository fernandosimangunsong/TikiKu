                ...
                <div class="sidebar-nav">
                    <div class="nav-canvas">
                        ...
                        <ul class="nav nav-pills nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="index.php?dashboard"><i class="glyphicon glyphicon-home"></i><span> Dashboard</span></a>
                            </li>

                            <li><a class="ajax-link" href="index.php?"><i class="glyphicon glyphicon-home"></i><span> Tarif Pengiriman</span></a>
                            </li>

                             <li><a class="ajax-link" href="index.php?formTrack"><i class="glyphicon glyphicon-home"></i><span> Lacak Pengiriman</span></a>
                            </li>

                             <li><a class="ajax-link" href="index.php?aboutUs"><i class="glyphicon glyphicon-home"></i><span>About Us</span></a>
                            </li>
